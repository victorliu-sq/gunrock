#include <gunrock/algorithms/sssp_throughput.hxx>
...
void test_sssp(int num_arguments, char** argument_array) {
  ...
  unsigned long long total_edges_processed = 0;
  ...
  for (int i = 0; i < n_runs; i++) {
    ...
    total_edges_processed += h_edges_processed[0];
