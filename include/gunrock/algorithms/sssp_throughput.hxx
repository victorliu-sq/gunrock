...
struct enactor_t : gunrock::enactor_t<problem_t> {
  ...
  void loop(gcuda::multi_context_t& context) override {
    ...
    auto shortest_path = [distances, single_source, edge_counter] __host__ __device__(
...
float run(graph_t& G,
  ...
  result_type result(distances, predecessors, G.get_number_of_vertices(), edge_counter);
  // </user-defined>
